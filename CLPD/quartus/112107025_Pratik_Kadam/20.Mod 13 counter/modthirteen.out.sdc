## Generated SDC file "modthirteen.out.sdc"
...
set_output_delay -add_delay -max -clock [get_clocks {clk}]  2.000 [get_ports {out[0]}]
set_output_delay -add_delay -max -clock [get_clocks {clk}]  2.000 [get_ports {out[1]}]
set_output_delay -add_delay -max -clock [get_clocks {clk}]  2.000 [get_ports {out[2]}]
set_output_delay -add_delay -max -clock [get_clocks {clk}]  2.000 [get_ports {out[3]}]
